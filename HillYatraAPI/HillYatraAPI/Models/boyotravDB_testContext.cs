...
{
    public partial class boyotravDB_testContext : DbContext
    {
        public boyotravDB_testContext()
        {
        }

        public boyotravDB_testContext(DbContextOptions<boyotravDB_testContext> options)
            : base(options)
        {
        }
